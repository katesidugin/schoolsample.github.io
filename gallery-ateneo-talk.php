    ...
    <div class="gt_sub_banner_bg default_width">
		...
		<div class="container">
			<div class="gt_sub_banner_hdg default_width" >
                ...
                <h2>Ateneo Recruitment Talk<br>Attended by Ednassians</h2>
      ...
      <div class="container">
        <div class="gt_breadcrumb_wrap default_width">
            <ul>
				...
				<li><a href="#">Ateneo Recruitment Talk</a></li>
            </ul>
        </div>
      </div>
    </div>
		...
		<section class="gt_who_we_bg">
			<div class="container">
				<div class="gallery">
					...
					<div class="col-md-8">
						<p class="mb20" style="text-align:center;">Ateneo Recruitment Talk by Dr. Jumela F. Sarmiento (Faculty, Department of Mathematics, Former Director of the Office of Admission and Aid, Ateneo De Manila University) Thursday, 10 August 2017.<br>

						The event was attended by the Grade 12 students of Ednas School, Ednas School of San Carlos, and Ednas School of Alaminos together with the other grade 12 students from other private schools in Pangasinan</p>
					</div>
				<ul class="row">
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ateneo Talk/IMG_7701.JPG">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ateneo Talk/IMG_7702.JPG">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ateneo Talk/IMG_7703.JPG">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ateneo Talk/IMG_7704.JPG">
					</li>
				
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ateneo Talk/IMG_7705.JPG">
					</li>
					
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ateneo Talk/IMG_7706.JPG">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ateneo Talk/IMG_7707.JPG">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ateneo Talk/IMG_7709.JPG">
					</li>
