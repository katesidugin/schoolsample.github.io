    ...
    <div class="gt_sub_banner_bg default_width">
		...
		<div class="container">
			<div class="gt_sub_banner_hdg default_width" >
                ...
                <h2>Induction of Club and Homeroom Officers at Ednas School<br>(Friday, 11 August 2017)</h2>
			...
			<div class="container">
				...
				<ul class="row">
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ednas Dagupan Photos/Induction of Officers/1.JPG">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ednas Dagupan Photos/Induction of Officers/2.JPG">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ednas Dagupan Photos/Induction of Officers/3.JPG">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ednas Dagupan Photos/Induction of Officers/4.JPG">
					</li>
				
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ednas Dagupan Photos/Induction of Officers/5.JPG">
					</li>
				  </ul>
				</div>
			</div>
