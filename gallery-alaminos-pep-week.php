    ...
    <div class="gt_sub_banner_bg default_width">
		...
		<div class="container">
			<div class="gt_sub_banner_hdg default_width" >
                ...
                <h2>Pep Week Culminating Activity of<br>Ednas School of Alaminos</h2>
			...
			<div class="container">
				...
				<ul class="row">
					<li class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/Pep Week/1.jpg">
					</li>
					<li class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/Pep Week/2.jpg">
					</li>
					<li class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/Pep Week/3.jpg">
					</li>
