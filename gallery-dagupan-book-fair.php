    ...
    <div class="gt_sub_banner_bg default_width">
		...
		<div class="container">
			<div class="gt_sub_banner_hdg default_width" >
                ...
                <h2>Ednas School Book Fair<br>(14 - 18 August 2017)</h2>
			...
			<div class="container">
				...
				<ul class="row">
					<li class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ednas Dagupan Photos/Book Fair/1.JPG">
					</li>
					<li class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ednas Dagupan Photos/Book Fair/2.JPG">
					</li>
					<li class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ednas Dagupan Photos/Book Fair/3.JPG">
					</li>
				  </ul>
				</div>
			</div>
