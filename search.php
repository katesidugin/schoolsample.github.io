            ...
            <div class="gt_d_classes_wrap default_width">
               <div class="gt_d_fav_courses default_width">
                <ul class="gt_d_fav_hdg">
                  <li>Search Key:<br>'<b><?php echo $_GET["search"]; ?></b>'</li>
					...
					<?php
								...
								if (isset($_GET['search'])){
									...
									if ($key == ""){
										$res.= '<li>';
										$res.= '<div class="gt-text">';
										$res.= '<h5>No Results Found.</h5>';
										$res.= '</div>';
										$res.= '</li>';
									}
									
									else{
										$conn = @mysql_connect("localhost","ednasschool","3dNas");
										mysql_select_db("ednas_data");
										...
										$str = addslashes($key);
										$query = "select link, title from search where content like '%".$str."%' or title like '%".$str."%' order by title"; 
										...
										while ( $row = mysql_fetch_assoc($result) ){
												...
												$res.= '<li>';
												$res.= '<div class="gt-text" style="cursor:pointer;">';
												$res.= '<h5><a href="'.$row['link'].'" style="margin-top:10px;">'.$row['title'].'</a></h5>';
												$res.= '</div>';
												$res.= '</li>';
												$a++;
