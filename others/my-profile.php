        ...
        <div class="container">
          <div class="gt_top_element">
            <ul>
              ...
              <li><a href="login-register.html" id="parents_resources2">Parents</a></li>
        ...
        <div class="container">
          ...
          <div class="col-md-4">
            <div class="gt-user-sidebar">
              ...
              <div class="gt-usser-account-list">
                <ul>
                  <li class="active"><a href="my-profile.php" ><i class="fa fa-user-circle-o gt-color"></i>My Profile</a></li>
                  <li><a href="add-profile.php"><i class="fa fa-user-plus gt-color"></i>New Account</a></li>
          ...
          <div class="col-md-8">
			<div class="gt_d_classes_wrap default_width mb20">
              <h4 class="gt_d_title">Profile</h4>
                ...
                <div class="row">
                  <div class="col-md-7">
                    ...
                    <div class="gt_privacy_field default_width mb20">
                      <input id="old_username" class="c_ph" type="text" value="<?php echo $_SESSION["user"][0][2];?>" disabled>
                    </div>
                  </div>
				  ...
				  <div class="col-md-7">
                    ...
                    <div class="gt_privacy_field default_width mb20">
                      <input id="new_username" class="c_ph" type="text">
                    </div>
                  </div>
				 ...
				 <div class="col-md-7">
                    ...
                    <div class="gt_privacy_field default_width mb20">
                      <input id="old_password" class="c_ph" type="password" value="<?php echo $_SESSION["user"][0][3];?>" disabled>
                    </div>
                  </div>
				  ...
				  <div class="col-md-7">
                    ...
                    <div class="gt_privacy_field default_width mb20">
                      <input id="new_password" class="c_ph" type="password">
                    </div>
                  </div>
				  ...
				  <div class="col-md-7">
                    ...
                    <div class="gt_privacy_field default_width mb20">
                      <input id="cnew_password" class="c_ph" type="password">
                    </div>
                  </div>
					
					<div class="col-md-12">
						<div class="gt_d_profile_detail">
						<label id="err_message"style="color:red;"><span></span></label>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="gt_privacy_field default_width">
						  <input id="btn_update" type="submit" value="Update Profile" style="background-color:#008000;">
						</div>
                  </div>
                </div>
              </div>
