      ...
      <div class="container">
        <div class="gt_breadcrumb_wrap default_width">
            <ul>
                ...
                <li><a href="#">List of Subscribers</a></li>
            </ul>
        </div>
      </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="gt-user-sidebar">
              ...
              <div class="gt-usser-account-list">
                <ul>
                  ...
                  <li class="active"><a href="list-profile.php"><i class="fa fa-list gt-color"></i>List of Subscribers</a></li>
                </ul>
          ...
          <div class="col-md-8">
			<div class="gt_d_classes_wrap default_width mb20">
              <h4 class="gt_d_title">List of Subscribers</h4>
			  <div class="col-sm-12 text-right" hidden>
				<button title="Print" id="btn_print" type="button" class="btn btn-primary" style="margin-bottom:20px;"><span class="fa fa-print"></span></button>
			  </div>
			  <div id="table_area"style="max-height: 250px; min-height:250px; overflow-y: scroll; border: 0.5px solid #ffffff;">          
