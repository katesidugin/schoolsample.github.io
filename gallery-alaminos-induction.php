    ...
    <div class="gt_sub_banner_bg default_width">
		...
		<div class="container">
			<div class="gt_sub_banner_hdg default_width" >
                ...
                <h2>INDUCTION OF CLUB AND HOMEROOM OFFICERS AT EDNAS SCHOOL OF ALAMINOS<br>(FRIDAY, 11 AUGUST 2017)</h2>
			...
			<div class="container">
				...
				<ul class="row">
					<li class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/Induction of Officers/1.jpg">
					</li>
					<li class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/Induction of Officers/2.jpg">
					</li>
					<li class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/Induction of Officers/3.jpg">
					</li>
