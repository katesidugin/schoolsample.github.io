...
<body>
    ...
    <div class="gt_content_wrap">
      ...
      <section class="gt_courses_bg">
        <div class="container">
            ...
            <div class="gt-user-sidebar">
              ...
              <div class="gt-usser-account-list">
                <ul>
                  ...
                  <li class="active"><a href="my-files-parent.php"><i class="fa fa-file gt-color"></i>My Files</a></li>
          ...
          <div class="col-md-8">
            <div class="gt_d_classes_wrap default_width">
               <div class="gt_d_fav_courses default_width">
                ...
                <ul class="gt-shortlisted">
                  <li>
                    ...
                    <div class="gt-text" style="cursor:pointer;" id="pdf_conduct">
                      
                      <h5><a href="" >Ednas Technology of Conduct</a></h5>
                      <span class="gt-user-name gt-color"><em></em> Ednas School</span>
                      
                      </div>
                  </li>
                  <li>
                    <div class="gt-text" style="cursor:pointer;" id="pdf_handbook">
                      
                      <h5><a href="">Parent - Student Handbook</a></h5>
                      <span class="gt-user-name gt-color"><em></em> Ednas School</span>
  ...
  <script src="js/my-files-parent.js"></script>
</body>
</html>
