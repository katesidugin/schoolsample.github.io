    ...
    <div class="gt_sub_banner_bg default_width">
		...
		<div class="container">
			<div class="gt_sub_banner_hdg default_width" >
                ...
                <h2>INDUCTION OF CLUB AND HOMEROOM OFFICERS AT EDNAS SCHOOL of San Carlos<br>(FRIDAY, 11 AUGUST 2017)</h2>
      ...
      <div class="container">
        <div class="gt_breadcrumb_wrap default_width">
            <ul>
				...
				<li><a href="#">Induction of Club and Homeroom Officers</a></li>
            </ul>
        </div>
      </div>
    </div>
			...
			<div class="container">
				...
				<ul class="row">
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ednas San Carlos Photos/Induction of Officers/1.jpg">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ednas San Carlos Photos/Induction of Officers/2.jpg">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ednas San Carlos Photos/Induction of Officers/3.jpg">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ednas San Carlos Photos/Induction of Officers/4.jpg">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ednas San Carlos Photos/Induction of Officers/5.jpg">
					</li>
				  </ul>
				</div>
			</div>
