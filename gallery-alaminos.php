      ...
      <div class="container">
        <div class="gt_breadcrumb_wrap default_width">
            <ul>
				...
				<li><a href="#">Alaminos Campus</a></li>
            </ul>
        </div>
      </div>
    </div>
			...
			<div class="container">
				...
				<ul class="row">
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/alaminos1.jpg">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/alaminos2.jpg">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/alaminos3.jpg">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/alaminos4.jpg">
					</li>
				
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/foundation1.jpg">
					</li>
					
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/grad.jpg">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/prom1.jpg">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/prom2.jpg">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/recog1.jpg">
					</li>
				  </ul>
				</div>
			</div>
