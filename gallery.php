		...
		<section class="gt_who_we_bg">
			<div class="container">
				...
				<div class="col-md-4 album">
					<a href="gallery-alaminos-book-fair.php"><img src="images/EDNAS Alaminos Photos/Book Fair/gallery.jpg"></a>
				</div>
				
				<div class="col-md-4 album">
					<a href="gallery-alaminos-induction.php"><img src="images/EDNAS Alaminos Photos/Induction of Officers/gallery.jpg"></a>
				</div>
				
				<div class="col-md-4 album">
					<a href="gallery-alaminos-pep-week.php"><img src="images/EDNAS Alaminos Photos/Pep Week/gallery.jpg"></a>
				</div>
				
				<div class="col-md-4 album">
					<a href="gallery-sancarlos-book-fair.php"><img src="images/Ednas San Carlos Photos/Book Fair/gallery.jpg"></a>
				</div>
				
				<div class="col-md-4 album">
					<a href="gallery-sancarlos-induction.php"><img src="images/Ednas San Carlos Photos/Induction of Officers/gallery.jpg"></a>
				</div>
				
				<div class="col-md-4 album">
					<a href="gallery-sancarlos-pep-week.php"><img src="images/Ednas San Carlos Photos/Pep Week/gallery.jpg"></a>
				</div>
			
				<div class="col-md-4 album">
					<a href="gallery-dagupan-book-fair.php"><img src="images/Ednas Dagupan Photos/Book Fair/gallery.jpg"></a>
				</div>
				
				<div class="col-md-4 album">
					<a href="gallery-dagupan-induction.php"><img src="images/Ednas Dagupan Photos/Induction of Officers/gallery.jpg"></a>
				</div>
			
				<div class="col-md-4 album">
					<a href="gallery-ateneo-talk.php"><img src="images/Ateneo Talk/gallery.jpg"></a>
				</div>
				
			
				<div class="col-md-4 album">
					<a href="gallery-dagupan.php"><img src="images/Ednas Dagupan Photos/gallery.jpg"></a>
					
				</div>
				
				<div class="col-md-4 album">
					
					<a href="gallery-san-carlos.php"><img src="images/Ednas San Carlos Photos/gallery.jpg"></a>
					
				</div>
				
				<div class="col-md-4 album">
					
					<a href="gallery-alaminos.php"><img src="images/EDNAS Alaminos Photos/gallery.jpg"></a>
					
				</div>
				
				<div class="col-md-4 album">
					<a href="gallery-anniversary.php"><img src="images/50th anniversary/gallery.jpg"></a>
				</div>
