      ...
      <div class="container">
        <div class="gt_breadcrumb_wrap default_width">
            <ul>
				...
				<li><a href="#">50th Anniversary Celebration</a></li>
            </ul>
        </div>
      </div>
    </div>
			...
			<div class="container">
				...
				<ul class="row">
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/50th anniversary/1.JPG">
					</li>
					
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/50th anniversary/2.JPG">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/50th anniversary/3.JPG">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/50th anniversary/4.JPG">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/50th anniversary/5.JPG">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/50th anniversary/6.JPG">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/50th anniversary/7.JPG">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/50th anniversary/8.JPG">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/50th anniversary/9.JPG">
					</li>
				  </ul>
				</div>
			</div>
