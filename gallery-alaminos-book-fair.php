    ...
    <div class="gt_sub_banner_bg default_width">
		...
		<div class="container">
			<div class="gt_sub_banner_hdg default_width" >
                ...
                <h2>Ednas School of Alaminos Book Fair<br>(14 - 18 AUGUST 2017)</h2>
			...
			<div class="container">
				...
				<ul class="row">
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/Book Fair/1.jpg">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/Book Fair/2.jpg">
					</li>
					<li class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/EDNAS Alaminos Photos/Book Fair/3.jpg">
					</li>
