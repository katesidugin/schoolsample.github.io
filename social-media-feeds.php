...
<body>
  ...
  <div class="gt_wrapper">
             ...
             <li><a href="index.php">Home</a>
              ...
              <li><a href="javascript:avoid(0);">News & Media</a>
                <ul>
					...
					<li class="active"><a href="#">Social Media Accounts</a></li>
    ...
    <div class="gt_sub_banner_bg default_width img-responsive">
      ...
      <section class="gt_who_we_bg">
        <div class="container">
			...
			<div class="col-md-6 col-sm-12" style="margin-bottom:15px;">
				<img src="images/EdnasParents.jpg" alt="" style="border: 1px solid #0070bb;">
			</div>
			
			<div class="col-md-6 col-sm-12" style="margin-bottom:15px;">
				<img src="images/Slide1.jpg" alt="" style="border: 1px solid #0070bb;">
			</div>
			
			<div class="col-md-6 col-sm-12" style="margin-bottom:15px;">
				<img src="images/Slide2.jpg" alt="" style="border: 1px solid #0070bb;">
			</div>
			
			<div class="col-md-6 col-sm-12" style="margin-bottom:15px;">
				<img src="images/Slide3.jpg" alt="" style="border: 1px solid #0070bb;">
			</div>
            ...
            <div class="col-md-12">
				...
				<div class="col-md-3">
					<br>
					<br>
					<center><h6>Join us on our <i title="Facebook" class="fa fa-facebook-official" aria-hidden="true" style="color:#3b5998;font-size:30px;"></i> Group<br></h6> <br><a href="https://www.facebook.com/groups/ednasofficial"><h6><b>EDNAS School Official</b></h6></a></center>
					
				</div>
				
				<div class="col-md-3">
				<br><br>
					<center><h6>Follow us on <i class="fa fa-twitter-square" aria-hidden="true" style="color:#4099FF;font-size:30px;"></i></h6> <br> <a href="https://twitter.com/search?q=%40ednasofficial&src=typd"><h6><b>@ednasofficial</b></h6></a></center>
					
				</div>
				
				<div class="col-md-3">
				<br><br>
					<center><h6>Follow us on <i class="fa fa-instagram" aria-hidden="true" style="color:#e4405F;font-size:30px;"></i></h6> <br><a href="https://www.instagram.com/ednasofficial"><h6><b>@ednasofficial</b></h6></a></center>
				</div>
				
				<div class="col-md-3">
				<br><br>
					<center><h6>Subscribe on our <i class="fa fa-youtube" aria-hidden="true" style="color:#cd201F;font-size:30px;"></i> Account</h6> <br><a href="https://www.youtube.com/channel/UCIjeT6_6e6bcF2vwV-AMtNw"><h6><b>Ednas School Official</b></h6></a><center>
				</div>
          </div>
        </div>
      </section>
