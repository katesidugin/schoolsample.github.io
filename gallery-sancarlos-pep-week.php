    ...
    <div class="gt_sub_banner_bg default_width">
		...
		<div class="container">
			<div class="gt_sub_banner_hdg default_width" >
                ...
                <h2>Pep Week Culminating Activity of<br>Ednas School of San Carlos</h2>
			...
			<div class="container">
				...
				<ul class="row">
					<li class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ednas San Carlos Photos/Pep Week/1.jpg">
					</li>
					<li class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ednas San Carlos Photos/Pep Week/2.jpg">
					</li>
					<li class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
						<img class="img-responsive" src="images/Ednas San Carlos Photos/Pep Week/3.jpg">
					</li>
				  </ul>
				</div>
			</div>
