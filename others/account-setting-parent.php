          ...
          <div class="col-md-4">
            <div class="gt-user-sidebar">
              ...
              <div class="gt-usser-account-list">
                <ul>
                  <li><a href="my-profile-parent.php"><i class="fa fa-user-circle-o gt-color"></i>My Profile</a></li>
                  <li><a href="my-files-parent.php"><i class="fa fa-file gt-color"></i>My Files</a></li>
                  <li class="active"><a href="account-setting-parent.php"><i class="icon-three gt-color"></i>Account Setting</a></li>
                  </ul>
