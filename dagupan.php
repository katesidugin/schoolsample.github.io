      ...
      <div class="gt_top2_wrap default_width">
        <div class="container">
          <div class="gt_top_element">
            <ul>
              <li><a href="students-resources.php">Student</a></li>
            ...
            <ul>
              ...
              <li><a href="javascript:avoid(0);">Campuses</a>
                <ul>
					...
					<li class="active"><a href="#">Dagupan</a></li>
				  ...
				  <div class="swiper-container" id="swiper-container">
					 <ul class="swiper-wrapper">
						<li class="swiper-slide" >
							<img src="images/campus/Dagupan/dagupan1.jpg" alt="">
						</li>
						<li class="swiper-slide" >
							<img src="images/campus/Dagupan/dagupan2.jpg" alt="">
						</li>
						<li class="swiper-slide" >
							<img src="images/campus/Dagupan/dagupan3.jpg" alt="">
						</li>
						<li class="swiper-slide" >
							<img src="images/campus/Dagupan/dagupan4.jpg" alt="">
						</li>
						<li class="swiper-slide" >
							<img src="images/campus/Dagupan/dagupan5.jpg" alt="">
						</li>
						<li class="swiper-slide" >
							<img src="images/campus/Dagupan/dagupan6.jpg" alt="">
						</li>
						<li class="swiper-slide" >
							<img src="images/campus/Dagupan/dagupan7.jpg" alt="">
						</li>
						<li class="swiper-slide" >
							<img src="images/campus/Dagupan/dagupan8.jpg" alt="">
						</li>
						<li class="swiper-slide" >
							<img src="images/campus/Dagupan/dagupan9.jpg" alt="">
						</li>
					 </ul>
				   </div>
